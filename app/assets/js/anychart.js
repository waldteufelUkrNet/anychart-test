...
function drawChart(data) {
  ...
  if (dataType == 'ohlc') {
    // створити об'єкт anychart
    chart = anychart.ohlc(); // створити лінію на графіку

    series = chart.ohlc(data);
  } else if (dataType == 'candlestick') {
    // створити об'єкт anychart
    chart = anychart.candlestick(); // створити лінію на графіку

    series = chart.candlestick(data);
  } else if (dataType == 'areaspline') {
    // створити об'єкт anychart
    chart = anychart.line(); // створити лінію на графіку
  ...
  var dateTimeScale = anychart.scales.dateTime();
  chart.xScale(dateTimeScale); // Заголовок графіка
