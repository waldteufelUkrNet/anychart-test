    ...
    success: function success(data) {
      ...
      if (dataType == 'areaspline') {
        ...
        for (var _i3 = 0; _i3 < data.length; _i3++) {
          ...
          var tempArr = [];
          tempArr.push(Date.UTC(_tempYear, _tempMonth, _tempDay, _tempHours, _tempMinutes));
          tempArr.push(data[_i3].Open);
          tempArr.push(data[_i3].Hight);
          tempArr.push(data[_i3].Low);
          tempArr.push(data[_i3].Close);
...
function drawChart(data) {
  ...
  $('#graphic').empty(); // let chart, series;
  // if ( dataType == 'ohlc' ) {
  //   // створити об'єкт anychart
  //   chart = anychart.ohlc();
  //   // створити лінію на графіку
  ...
  mapping.addField('value', 4, 'last'); // defining the chart type

  var chart = anychart.stock();
  chart.plot(0).ohlc(mapping); // var grouping = chart.grouping();
  // grouping.minPixPerPoint(40);

  chart.container('graphic');
  chart.draw(); // setTimeout(function(){
  //   table.remove();
  // }, 3000);
} // ↑↑↑ FUNCTIONS DECLARATION ↑↑↑
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
